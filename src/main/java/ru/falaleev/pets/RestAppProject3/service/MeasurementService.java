...
import ru.falaleev.pets.RestAppProject3.repositories.MeasurementRepository;
...
@Autowired
    ...
    //данным методом возвращаем все измерения
    ...
    public void enrichMeasurement(Measurement measurement) {
        ...
        measurement.setMeasurementTimeDate(LocalDateTime.now());
    }
